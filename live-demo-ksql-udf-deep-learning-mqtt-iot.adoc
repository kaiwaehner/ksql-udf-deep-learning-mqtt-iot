...
So if your Confluent Platform installation is at `/Users/kai.waehner/confluent-5.4.0` then copy the JAR to `/Users/kai.waehner/confluent-5.4.0/etc/ksql/ext`
